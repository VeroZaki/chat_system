...
class ApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create application" do
    assert_difference("application.count") do
      post applications_url, params: { application: { chats_count: @application.chats_count, token: @application.token } }
    end
  ...
  test "should update application" do
    patch application_url(@application), params: { application: { chats_count: @application.chats_count, token: @application.token } }
